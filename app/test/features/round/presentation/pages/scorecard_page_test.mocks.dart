...
// in la_pocha/test/features/round/presentation/pages/scorecard_page_test.dart.
...
class _FakeGameScorecard_0 extends _i1.SmartFake implements _i2.GameScorecard {
  _FakeGameScorecard_0(Object parent, Invocation parentInvocation)
...
/// A class which mocks [GetGameScorecardUseCase].
///
...
class MockGetGameScorecardUseCase extends _i1.Mock
  ...
  _i5.Future<_i2.GameScorecard> call({required String? gameId}) =>
      (super.noSuchMethod(
            ...
            returnValue: _i5.Future<_i2.GameScorecard>.value(
              _FakeGameScorecard_0(
                this,
                Invocation.method(#call, [], {#gameId: gameId}),
              ),
            ),
            returnValueForMissingStub: _i5.Future<_i2.GameScorecard>.value(
              _FakeGameScorecard_0(
                this,
                Invocation.method(#call, [], {#gameId: gameId}),
              ),
          ...
          as _i5.Future<_i2.GameScorecard>);
}

/// A class which mocks [CancelGameUseCase].
///
/// See the documentation for Mockito's code generation for more information.
class MockCancelGameUseCase extends _i1.Mock implements _i6.CancelGameUseCase {
  @override
